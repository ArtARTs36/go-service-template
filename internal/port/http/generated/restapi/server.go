...
type Server struct {
	...
	SocketPath    flags.Filename `long:"socket-path" description:"the unix socket to listen on" default:"/var/run/cars.sock"`
...
func (s *Server) SetAPI(api *operations.CarsAPI) {
	if api == nil {
		s.api = nil
		s.handler = nil
		return
